...
//   }, []);
  ...
  return (
    <div className="font-sans">
      ...
      <section
        id="home"
        className="h-screen flex items-center justify-center text-center text-white mt-16 bg-gradient-to-br from-[#1a1a2e] to-[#16213e] relative"
      >
      ...
      <section
        id="services"
        className="py-16 px-8 max-w-7xl mx-auto bg-gray-50"
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-12">
          ...
          <div className="bg-white p-8 rounded-xl shadow-lg hover:-translate-y-3 transition-transform">
            ...
            <p className="text-gray-700">
              Pastillas de freno premium, discos, calipers y componentes
              completos del sistema de frenos para una potencia de frenado
              segura.
            </p>
          </div>
          <div className="bg-white p-8 rounded-xl shadow-lg hover:-translate-y-3 transition-transform">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-lg text-gray-700">
              ...
              personalizado. Nuestro equipo puede ayudarle a encontrar
              exactamente la pieza correcta para su aplicación específica.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center p-6 bg-white rounded-xl shadow">
              <div className="text-5xl font-bold text-[#e94560] mb-2">
                10.000
              </div>
      ...
      <section
        id="contact"
        className="py-16 px-8 max-w-7xl mx-auto bg-[#1a1a2e] text-white"
      >
